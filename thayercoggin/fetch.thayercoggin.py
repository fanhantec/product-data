...
class Product():
    ...
    def __init__(self):
        ...
        self.brand_name = "Thayer Coggin"
        self.brand_alia = "thayercoggin"
        self.base_url = "http://www.thayercoggin.com/"
    ...
    def dump_product_db(self):
        print(u"\n备份数据库: brand_collection 和 product_collection")
        # 导出brand_collection
    ...
    def export_db_brand_collection(self):
        ...
        with open("output." + self.brand_alia + ".brand.collection", "w") as f:
            f.write(output)
        print(u"导出完成")
    ...
    def export_db_product_collection(self):
        ...
        for product in self.product_collection.find():
            ...
            output += product_tag + "\n"          
        output = output[:-1]
        with open("output." + self.brand_alia + ".product.collection", "w") as f:
            f.write(output)
        print(u"导出完成")
    ...
    def export_product_tag(self):
        ...
        with open("output." + self.brand_alia + ".product.tag", "w") as f:
            f.write(output)
        print(u"导出完成")
        os.system("tar -czvf " + self.brand_alia + "-上线数据.tar.gz " + "output." + self.brand_alia + ".product.tag")
    ...
    def get_product_tag(self, product_url, product_html):
        ...
        # production_name
        production_name = product_html.find("span", class_="onecolumnheader").get_text().strip()
        print("production_name:", production_name)
        # sku
        sku = product_html.find("span", class_="threecolumntextheader").get_text().strip().split(" ")[1]
        print("sku:", sku)
        # size
        size = ""
        # description
    ...
    def get_product_img_urls(self, product_html):
        img_urls = []
        img_src = product_html.find("img", width="820", height="500").get("src")
    ...
    def get_product_urls(self, html):
        ...
        # 先处理类别
        page_urls = [
            "http://www.thayercoggin.com/sectionalgallery1.html",
            "http://www.thayercoggin.com/sectionalgallery2.html",
            "http://www.thayercoggin.com/sectionalgallery3.html",
            "http://www.thayercoggin.com/sectionalgallery4.html",
            "http://www.thayercoggin.com/sofagallery1.html",
            "http://www.thayercoggin.com/sofagallery2.html",
            "http://www.thayercoggin.com/sofagallery3.html",
            "http://www.thayercoggin.com/dininggallery1.html",
            "http://www.thayercoggin.com/loungegallery1.html",
            "http://www.thayercoggin.com/loungegallery2.html",
            "http://www.thayercoggin.com/loungegallery3.html",
            "http://www.thayercoggin.com/loungegallery4.html",
            "http://www.thayercoggin.com/loungegallery5.html",
            "http://www.thayercoggin.com/loungegallery6.html",
            "http://www.thayercoggin.com/loungegallery7.html",
            "http://www.thayercoggin.com/motiongallery1.html",
            "http://www.thayercoggin.com/motiongallery2.html",
            "http://www.thayercoggin.com/baughmangallery1.html",
            "http://www.thayercoggin.com/baughmangallery2.html",
            "http://www.thayercoggin.com/baughmangallery3.html",
            "http://www.thayercoggin.com/baughmangallery4.html",
            "http://www.thayercoggin.com/baughmangallery5.html",
            "http://www.thayercoggin.com/baughmangallery6.html",
            "http://www.thayercoggin.com/baughmangallery7.html",
            "http://www.thayercoggin.com/baughmangallery8.html",
            "http://www.thayercoggin.com/tablegallery1.html",
            "http://www.thayercoggin.com/tablegallery2.html",
            "http://www.thayercoggin.com/tablegallery3.html",
            "http://www.thayercoggin.com/ottomangallery1.html",
            "http://www.thayercoggin.com/midcentury1.html",
            "http://www.thayercoggin.com/midcentury2.html",
            "http://www.thayercoggin.com/midcentury3.html",
            "http://www.thayercoggin.com/midcentury4.html",
            "http://www.thayercoggin.com/midcentury5.html",
            "http://www.thayercoggin.com/midcentury6.html",
        ]
        brand_products = self.brand_collection.find_one({"brand_alia": self.brand_alia})
        last_page = 0
        # 获取数据库中的记录，用于跳过
        ...
        for page_url in page_urls:
            ...
            tag_div = page_html.find_all("div", align="center")
            for div in tag_div:
                if len(list(div.children)) == 0 or list(div.children)[0].name != "a":
                    continue          
