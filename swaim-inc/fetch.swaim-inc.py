...
class Product():
    ...
    def __init__(self):
        ...
        self.brand_name = "Swaim Inc"
        self.brand_alia = "swaim-inc"
        self.base_url = "http://swaim-inc.com/collections"
    ...
    def get_product_urls(self, html):
        ...
        for page in range(1, int(max_page)+1):
            page_url = "http:http://swaim-inc.com/collections?limit=36&p=" + str(page)
            ...
            tag_div = page_html.find("div", class_="category-products")
            tag_li = tag_div.find("ul").find_all("li")
            for li in tag_li:
                product_url = li.find("h2", class_="product-name").find("a").get("href")
